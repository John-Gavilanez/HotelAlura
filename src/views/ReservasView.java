...
public class ReservasView extends JFrame {
	...
	private reservaController ResevaController;
	...
	public ReservasView() {
		...
		this.ResevaController = new reservaController();
		...
		txtFechaSalida.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				calculoValor(txtFechaEntrada, txtFechaSalida);
			}
		});
	...
	private void guardarReserva() {
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null && !txtValor.equals("")
			...
			LocalDate FechaEntrada = LocalDate
			...
			Reserva reserva = new Reserva(FechaEntrada, FechaSalida, txtValor.getText(),
					txtFormaPago.getSelectedItem().toString());
			ResevaController.guardar(reserva);
	...
	public void calculoValor(JDateChooser FechaEntrada, JDateChooser FechaSalida) {

		if (FechaEntrada.getDate() != null && FechaSalida.getDate() != null) {

			if (FechaEntrada.getDate().after(FechaSalida.getDate())) {

				JOptionPane.showMessageDialog(null, "La fecha de entrada no puede estar antes que la fecha de salida",
